    ...
    <div className="container mx-auto px-4 py-16 md:py-24">
      <section className="text-center mb-16 md:mb-24">
        ...
        <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto">
          Have a question or a project in mind? Book a free consultation with us, We'd love to hear from you. Fill out the form below or reach out to us directly.
        </p>
      </section>
          ...
          <div className="space-y-8">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-primary text-md">123 Innovation Drive, Tech City, 10001</p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              <div className="bg-primary/10 rounded-full p-4 w-fit">
