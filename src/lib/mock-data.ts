...
export const mockPosts: Post[] = [
  {
    ...
    content: `
      ...
      <p>At PixelGlint, we embrace minimalist principles to create designs that are not only beautiful but also highly functional. It's about finding the perfect balance between form and function.</p>
    `
  },
  {
