          ...
          <div>
            ...
            <nav className="mt-4 flex flex-col space-y-3">
              {companyLinks.map(link => (
                <Link key={link.href} href={link.href} className="text-sm text-muted-foreground hover:text-primary transition-colors flex items-center gap-2">
                  {link.label}
                </Link>
              ))}
            </nav>
          ...
          <div>
            ...
            <nav className="mt-4 flex flex-col space-y-3">
               {serviceLinks.map(link => (
                <Link key={link.label} href={link.href} className="text-sm text-muted-foreground hover:text-primary transition-colors flex items-center gap-2">
                  {link.label}
                </Link>
              ))}
            </nav>
